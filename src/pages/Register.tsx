...
const Register = () => {
  ...
  const { register, loginWithGoogle, loginWithTwitter, loginWithApple } = useAuth();
  ...
  const handleSocialLogin = (provider: string) => {
    switch(provider) {
      ...
      case "Twitter":
        loginWithTwitter();
        toast({
          title: "Twitter registration successful",
          description: "Your account has been created.",
        });
        break;
      case "Apple":
        loginWithApple();
        toast({
          title: "Apple registration successful",
          description: "Your account has been created.",
        });
        break;
      default:
      ...
      <div className="container max-w-md mx-auto flex flex-col items-center justify-center px-6 py-12">
        <div className="w-full">
          <div className="mb-8 flex flex-col items-center justify-center">
            ...
            <h1 className="text-4xl font-bold tracking-tight mb-2">Sign Up</h1>
